...
//uzimam formu, broj paragrafa, i mesto gde upisujem
const form=document.querySelector('.lorem-form');
const amount = document.getElementById('amount');
const result=document.querySelector('.lorem-text');
//na SUBMIT od forme sprecavam slanje na server
form.addEventListener('submit',function(e){
  e.preventDefault();
  //posto mi amount vraca string ja pretvorim u int
...
//-1
// >9
//ako unese ove lose vrednosti dobija random 1 pasus
if(isNaN(value)||value<=0||value>9){
  result.innerHTML=`<p class="result">${text[random]}</p>`;
}else { // ako ne onda uzimam prvih TOLIKO pasusa
  let tempText=text.slice(0,value);
  //posto dobijam niz od prosle linije koda, moram funkcijom map da prodjem kroz taj niz i za svaki item da uradim ovo, i da joinujem u 1 string pa da upisem u html
